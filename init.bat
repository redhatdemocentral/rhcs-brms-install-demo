...
set PROJECT=git@github.com:redhatdemocentral/rhcs-brms-install-demo.git
...
if exist "%SRC_DIR%\%EAP%" (
        ...
        echo Need to download %EAP% package from developers.redhat.com
...
echo.
call oc start-build rhcs-brms-install-demo --from-dir=. --follow=true  --wait=true
...
echo.
call oc new-app rhcs-brms-install-demo
